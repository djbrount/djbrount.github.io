...
/*You can add additional lines if you have more fields, as long as they follow the same syntax as the first two lines here. These just check to ensure they're not empty, so validating on server-side.*/
   ...
   empty($_POST['message']))
{
    $errors .= "\n Please fill out all required fields.";  /*Change the message if you want.*/
}
...
{
	$to = $myemail;
	$email_subject = "Contact Form: $subject from $name";  /*This will appear in the subject line. Feel free to change the first part.*/
	$email_body = "$message";
